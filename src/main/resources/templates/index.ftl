...
<section id="container" >
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index.html" class="logo"><b>WATER QUALITY PROYECT</b></a>
        <!--logo end-->
            ...
            <ul class="nav top-menu">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src="dashGumTemplate/img/ui-zac.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src="dashGumTemplate/img/ui-divya.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src="dashGumTemplate/img/ui-danro.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src="dashGumTemplate/img/ui-sherman.jpg"></span>
                                <span class="subject">
